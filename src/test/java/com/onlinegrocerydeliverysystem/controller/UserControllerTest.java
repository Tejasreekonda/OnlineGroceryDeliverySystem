...
class UserControllerTest {
	 ...
	 */
	/*@Test
	void testLoginUser() throws UserNotFoundException, InvalidLoginCredentialsException {
		userService.loginUser("akanksha@gmail.com", "Akanksha@123");
		verify(userService,times(1)).loginUser("akanksha@gmail.com","Akanksha@123");
	}*/
