...
class OrderServiceImplTest {
	...
	void setUp() throws OrderIdNotFoundException, UserNotFoundException, ResourceNotFoundException
	{
		...
		product1 = new Product("A123","Apple",20,100,"Fruits");
		product1.setProductId(1L);
		product2 = new Product("A124","Mango",30,100,"Fruits");
	...
	@Test()
	void testViewOrderLongLongInvalidUserId() throws OrderIdNotFoundException, UserNotFoundException, ResourceNotFoundException
	{
	...
	@Test
	void testViewOrderLongLongInvalidOrderId() throws OrderIdNotFoundException, UserNotFoundException, ResourceNotFoundException
	{
		when(userRepository.existsById(1L)).thenReturn(true);
		when(orderRepository.findById(0)).thenReturn(null);
		try {
	...
	@Test
	void testViewOrderLongLongInvalidOrderIdAndUserId() throws OrderIdNotFoundException, UserNotFoundException, ResourceNotFoundException
	{
		when(userRepository.existsById(1L)).thenReturn(true);
