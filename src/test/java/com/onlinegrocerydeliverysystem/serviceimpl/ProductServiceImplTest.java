...
class ProductServiceImplTest {
	...
	void getAllProductsTest() {
		...
		Product prodOne = new Product("A123", "Apple", 20, 100, "Fruits");
		Product prodTwo = new Product("A124", "Mango", 30, 100, "Fruits");
		Product prodThree = new Product("A125", "Pineapple", 60, 100, "Fruits");
	...
	void getProductByIdTest() throws ProductNotFoundException {
		...
		Mockito.when(productService.getProductById(1L)).thenReturn(new Product("A123", "Apple", 20, 100, "Fruits"));
		Product p = productService.getProductById(1L);
		p.setProductId(9L);
		assertEquals("Apple", p.getProductName());
		assertEquals(9L, p.getProductId());
		assertEquals("A123", p.getProductCode());
	}
	...
	void createProductTest() throws ProductAlreadyExistException {
		Product p = new Product("A123", "Apple", 20, 100, "Fruits");
		p.setProductId(1L);
	...
	void updateProduct() throws ProductNotFoundException {
		...
		Product p = new Product("A123", "Apple", 20, 500, "Fruits");
