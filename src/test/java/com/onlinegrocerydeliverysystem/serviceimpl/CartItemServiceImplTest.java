...
class CartItemServiceImplTest {
	...
	void testAddToCart() throws UserNotFoundException, ProductNotFoundException, NotEnoughStockException {
		...
		Mockito.when(productRepository.findById(1L)).thenReturn(Optional.of(new Product("A123","Apple",20,100,"Fruits")));
	...
	void testUpdateCartItem() throws CartItemNotFoundException, NotEnoughStockException, ProductNotFoundException {
		...
		Mockito.when(productRepository.findById(1L)).thenReturn(Optional.of(new Product("A123","Apple",30,200,"Fruits")));
