...
class ProductControllerTest {
	...
	void testUpdateProduct() throws ProductNotFoundException {
		Product product = new Product("A123", "Mango", 20, 200, "Fruits");
	...
	void testGetallProducts() {
		...
		Product prodOne = new Product("A123", "Apple", 20, 100, "Fruits");
		Product prodTwo = new Product("A123", "Mango", 30, 100, "Fruits");
		Product prodThree = new Product("A123", "Pineapple", 60, 100, "Fruits");
